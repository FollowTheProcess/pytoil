...
def test_create_with_cookiecutter_correctly_invokes_cookiecutter(
    mocker: MockerFixture, fake_projects_dir, cookie_option, vscode
):
    ...
    # Whatever we try and create now, it will think it doesn't exist
    mocker.patch(
    ...
    mock_code = mocker.patch("pytoil.cli.project.VSCode.open", autospec=True)
    ...
    if vscode:
        ...
        assert "Opening 'myproject' in VSCode..." in result.stdout
