...
def test_sync_all_does_nothing_if_local_and_remote_are_synced(
    mocker: MockerFixture, temp_config_file, fake_projects_dir
):
...
def test_sync_all_respects_user_input_no(
    mocker: MockerFixture, temp_config_file, fake_projects_dir
):
...
def test_sync_all_respects_user_input_yes(
    mocker: MockerFixture, temp_config_file, fake_projects_dir
):
...
def test_sync_all_respects_force_flag(
    mocker: MockerFixture, temp_config_file, fake_projects_dir, force_flag
):
...
def test_sync_these_respects_user_input_no(
    mocker: MockerFixture, temp_config_file, fake_projects_dir
):
...
def test_sync_these_respects_user_input_yes(
    mocker: MockerFixture, temp_config_file, fake_projects_dir
):
