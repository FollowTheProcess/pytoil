...
@pytest.mark.asyncio
async def test_get_repos(httpx_mock: HTTPXMock, fake_get_repos_response):
    api = API(username="me", token="definitelynotatoken")

    httpx_mock.add_response(url=api.url, json=fake_get_repos_response, status_code=200)

    data = await api.get_repos()
    ...
    assert data == [
        {
            ...
            "updatedAt": "2022-01-09T06:55:32Z",
            "diskUsage": 45,
        },
        {
            ...
            "updatedAt": "2021-12-19T15:10:07Z",
            "diskUsage": 151,
        },
        {
            ...
            "updatedAt": "2021-01-20T10:35:57Z",
            "diskUsage": 2062,
        },
        {
            ...
            "updatedAt": "2021-12-03T08:45:49Z",
            "diskUsage": 734,
        },
        {
            "name": "cv",
            ...
            "updatedAt": "2022-01-10T19:50:24Z",
            "diskUsage": 145,
        },
        {
            ...
            "updatedAt": "2020-12-24T11:12:34Z",
            "diskUsage": 1834,
        },
        {
            ...
            "updatedAt": "2022-01-10T20:05:47Z",
            "diskUsage": 14640,
        },
        {
            ...
            "updatedAt": "2021-11-18T19:04:06Z",
            "diskUsage": 10753,
        },
    ]
